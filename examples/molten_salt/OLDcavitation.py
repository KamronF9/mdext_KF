...
def setup(lmp: PyLammps, seed: int) -> int:
    ...
    lmp.pair_coeff("1 1 0.263705848 0.317 2.340 1.048583006 -0.49932529") # Na-Na
    lmp.pair_coeff("2 2 0.158223509 0.317 3.170 72.40215779 -145.4284714")  # Cl-Cl
    lmp.pair_coeff("1 2 0.210964679 0.317 2.755 6.99055303  -8.675775756")  # Na-Cl
    # pair_coeff 1 1 0.158223509 0.317 3.170 72.40215779 -145.4284714  CLCL
